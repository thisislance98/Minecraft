...
export class LuaRuntime {
    constructor(game) {
        ...
        this._instances = new Map(); // Lua userdata -> JS object
    ...
    _registerVector3() {
        const Vector3 = {
            new: (x = 0, y = 0, z = 0) => ({
                ...
                // Arithmetic via metamethods handled separately
            }),
            zero: { _className: 'Vector3', X: 0, Y: 0, Z: 0, x: 0, y: 0, z: 0 },
            one: { _className: 'Vector3', X: 1, Y: 1, Z: 1, x: 1, y: 1, z: 1 },
            xAxis: { _className: 'Vector3', X: 1, Y: 0, Z: 0, x: 1, y: 0, z: 0 },
            yAxis: { _className: 'Vector3', X: 0, Y: 1, Z: 0, x: 0, y: 1, z: 0 },
            zAxis: { _className: 'Vector3', X: 0, Y: 0, Z: 1, x: 0, y: 0, z: 1 },
        };
    ...
    _registerColor3() {
        const Color3 = {
            ...
            fromRGB: (r, g, b) => Color3.new(r / 255, g / 255, b / 255),
            fromHSV: (h, s, v) => {
    ...
    _registerCFrame() {
        const CFrame = {
            new: (x = 0, y = 0, z = 0) => ({
                _className: 'CFrame',
                Position: this._getGlobal('Vector3').new(x, y, z),
                X: x, Y: y, Z: z,
            ...
            lookAt: (from, to) => {
                const cf = CFrame.new(from.X, from.Y, from.Z);
    ...
    _registerWorkspace() {
        ...
        const gameObj = {
            Workspace: workspace,
            Players: null, // Set in _registerPlayers
            GetService: (serviceName) => {
                if (serviceName === 'Workspace') return workspace;
                if (serviceName === 'Players') return gameObj.Players;
    ...
    _registerPlayers() {
        ...
        const localPlayer = {
            ...
            get Character() {
                ...
                return {
                    ...
                    get Position() {
                        return runtime._getGlobal('Vector3').new(
                            player.position.x,
                            player.position.y,
                            player.position.z
                        );
                    ...
                    get PrimaryPart() {
                        return {
                            ...
                            CFrame: runtime._getGlobal('CFrame').new(
                                player.position.x,
                                player.position.y,
                                player.position.z
                            )
        ...
        this._getGlobal('game').Players = Players;
    }
    ...
    _createPart() {
        const runtime = this;
        const Vector3 = this._getGlobal('Vector3');
        const Color3 = this._getGlobal('Color3');
        ...
        const part = {
            ...
            _size: Vector3.new(1, 1, 1),
            _position: Vector3.new(0, 0, 0),
            _color: Color3.new(0.5, 0.5, 0.5),
            _transparency: 0,
            _anchored: true,
            _canCollide: true,
            _material: 'Plastic',
            ...
            get CFrame() {
                return runtime._getGlobal('CFrame').new(
                    this._position.X,
                    this._position.Y,
                    this._position.Z
                );
    ...
    _createModel() {
        ...
        return {
            ...
            GetPivot: function() {
                ...
                return runtime._getGlobal('CFrame').new(0, 0, 0);
            },
    ...
    _createScript() {
        ...
        return {
            ...
            // Run the script
            Run: function() {
                if (this.Disabled || !this.Source) return;
                runtime.execute(this.Source, this.Name);
            }
        };
    }
    ...
    _createPointLight() {
        ...
        return {
            ...
            Parent: null,
            _brightness: 1,
            _color: runtime._getGlobal('Color3').new(1, 1, 1),
            _range: 10,
            _jsLight: null,
