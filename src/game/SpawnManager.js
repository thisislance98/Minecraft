...
import {
    ...
    Ladybug, Toucan, Gymnast, MagicalCreature, Raccoon, Shark, TRex, Lampost, Pumpkin, Lorax, Penguin
...
export class SpawnManager {
    ...
    spawnPack(AnimalClass, packSizeRange, baseX, baseZ, rng) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            // Aquatic check
            const isAquatic = (AnimalClass === Fish || AnimalClass === Turtle || AnimalClass === Duck || AnimalClass === Shark);

            if (AnimalClass === Fish || AnimalClass === Shark) {
