...
export class Player {
    ...
    createWand() {
        ...
        tip.renderOrder = 999;
        tip.position.y = 0.22; // Top of handle
        wandGroup.add(tip);

        // Position attached to hand
        // Point forward
        wandGroup.position.set(0, -0.35, 0);
        wandGroup.rotation.x = Math.PI / 2; // Point forward
        wandGroup.rotation.y = Math.PI / 2;

        this.rightArm.add(wandGroup);
        this.wand = wandGroup;
