...
- **Flying Creatures**: Read `.claude/skills/implementing-flying-creatures.md` before touching any flying creature (dragons, birds, bats, etc.). Setting `gravity=0` alone is NOT enough — flight requires custom movement code.
